...
var mobileAlert = function(){
  if (window.mobileAndTabletcheck() || detectmob()) {
    $(".hideToShow").show();
    $("#mobileCheck").attr("disabled",true);
    // alert("It looks like you are using a mobile device. This experiment doesn't run on mobile devices. Plese try on your computer or return this HIT.")
    // return
  }
}
